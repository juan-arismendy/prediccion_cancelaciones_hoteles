#!/usr/bin/env python3
"""
Script rápido para ejecutar el proyecto de predicción de cancelaciones de hoteles
Versión optimizada para velocidad - omite el modelo MLP que es muy lento
"""
...
def train_models(X, y, preprocessor):
    """Entrena y evalúa los modelos (versión rápida - sin MLP)"""
    print("\n=== ENTRENANDO MODELOS (VERSIÓN RÁPIDA) ===")
    print("⚠️  Nota: MLP omitido por ser computacionalmente costoso")
    ...
    param_grid_lr = {'classifier__C': [0.1, 1, 10]}  # Reducido para velocidad
    ...
    param_grid_knn = {
        'classifier__n_neighbors': [5, 7, 9],  # Reducido para velocidad
    ...
    param_grid_rf = {
        'classifier__n_estimators': [100, 200],  # Reducido para velocidad
    ...
    param_grid_svc = {
        ...
        'classifier__kernel': ['linear', 'rbf'],  # Reducido para velocidad
...
def print_summary(results):
    ...
    print("\n" + "="*60)
    print("RESUMEN DE RESULTADOS (VERSIÓN RÁPIDA)")
    print("="*60)
...
def main():
    ...
    print("💡 Para el modelo MLP completo, usa el notebook original en Jupyter.")
